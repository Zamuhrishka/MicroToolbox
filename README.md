...
Install MicroToolbox using the PlatformIO library manager in your editor, or using the PlatformIO Core CLI, or by adding it to your `platformio.ini` as shown below:
...
[env]
lib_deps =
    https://github.com/Zamuhrishka/MicroToolbox.git
```
