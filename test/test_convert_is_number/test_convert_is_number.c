...
int runTests(void) {
  UNITY_BEGIN();
  RUN_TEST(test_ConvertIsDecNumber_Positive);
  RUN_TEST(test_ConvertIsDecNumber_Negative);
  RUN_TEST(test_ConvertIsDecNumber_Invalid);
  RUN_TEST(test_ConvertIsHexNumber_Correct);
  RUN_TEST(test_ConvertIsHexNumber_Incorrect);
  return UNITY_END();
}
