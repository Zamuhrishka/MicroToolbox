...
{
  UNITY_BEGIN();
  RUN_TEST(test_min_positive);
  RUN_TEST(test_min_negative);
  RUN_TEST(test_min_mixed);
  RUN_TEST(test_min_equal);
  RUN_TEST(test_min_bl_positive);
  RUN_TEST(test_min_bl_negative);
  RUN_TEST(test_min_bl_mixed);
  RUN_TEST(test_min_bl_equal);
  RUN_TEST(test_max_positive);
  RUN_TEST(test_max_negative);
  RUN_TEST(test_max_mixed);
  RUN_TEST(test_max_equal);
  RUN_TEST(test_max_bl_positive);
  RUN_TEST(test_max_bl_negative);
  RUN_TEST(test_max_bl_mixed);
  RUN_TEST(test_max_bl_equal);
  RUN_TEST(test_equal_positive);
  RUN_TEST(test_equal_negative);
  RUN_TEST(test_equal_mixed);
  RUN_TEST(test_even);
  RUN_TEST(test_odd);
  RUN_TEST(test_invert_sigh);
  RUN_TEST(test_is_sigh_equal);
  RUN_TEST(test_arithmetical_mean);
  RUN_TEST(test_swap);
  RUN_TEST(test_is_power_2_valid);
  RUN_TEST(test_is_power_2_invalid);
  RUN_TEST(test_round_up);
  RUN_TEST(test_round_up_pow_2);
  return UNITY_END();
}
