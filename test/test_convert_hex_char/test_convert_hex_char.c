...
int runTests(void) {
  UNITY_BEGIN();
  RUN_TEST(test_ConvertHexNumToChar_Valid);
  RUN_TEST(test_ConvertHexNumToChar_Invalid);
  RUN_TEST(test_ConvertHexCharToNum_Valid);
  RUN_TEST(test_ConvertHexCharToNum_Invalid);
  return UNITY_END();
}
