...
int runTests(void) {
  UNITY_BEGIN();
  RUN_TEST(test_SetBitsInU8);
  RUN_TEST(test_SetBitsInU16);
  RUN_TEST(test_SetBitsInU32);
  RUN_TEST(test_ClearBitsInU8);
  RUN_TEST(test_ClearBitsInU16);
  RUN_TEST(test_ClearBitsInU32);
  RUN_TEST(test_ToggleBitsInU8);
  RUN_TEST(test_ToggleBitsInU16);
  RUN_TEST(test_ToggleBitsInU32);
  RUN_TEST(test_TestBits);
  RUN_TEST(test_Bitfield);
  RUN_TEST(test_NumBits);
  RUN_TEST(test_LSO);
  RUN_TEST(test_LCO);
  RUN_TEST(test_SLSB);
  RUN_TEST(test_CLSB);
  RUN_TEST(test_bits_mirror_u8);
  RUN_TEST(test_bits_mirror_u16);
  RUN_TEST(test_bits_mirror_u32);
  return UNITY_END();
}
