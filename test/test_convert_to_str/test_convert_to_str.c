...
int runTests(void) {
  UNITY_BEGIN();
  RUN_TEST(test_ConvertU8ToStr);
  RUN_TEST(test_ConvertI8ToStr);
  RUN_TEST(test_ConvertU16ToStr);
  RUN_TEST(test_ConvertI16ToStr);
  RUN_TEST(test_ConvertU32ToStr);
  RUN_TEST(test_ConvertI32ToStr);
  return UNITY_END();
}
