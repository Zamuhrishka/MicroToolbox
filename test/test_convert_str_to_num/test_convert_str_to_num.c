...
int runTests(void) {
  UNITY_BEGIN();
  RUN_TEST(test_ConvertStrToU8);
  RUN_TEST(test_ConvertStrToI8);
  RUN_TEST(test_ConvertStrToU16);
  RUN_TEST(test_ConvertStrToI16);
  RUN_TEST(test_ConvertStrToU32);
  RUN_TEST(test_ConvertStrToI32);
  return UNITY_END();
}
